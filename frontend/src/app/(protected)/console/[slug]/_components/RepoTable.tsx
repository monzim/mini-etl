...
export const columns: ColumnDef<Repo>[] = [
  ...
  },
  {
    ...
    header: "Forks",
    cell: ({ row }) => row.original.forks_count,
  },
  {
    accessorKey: "visibility",
    header: "Visibility",
    cell: ({ row }) => (row.original.private ? "Private" : "Public"),
  },
];
...
export default function RepoTable({ data }: Props) {
